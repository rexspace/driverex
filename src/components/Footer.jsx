function Footer() {
  return (
    <div className="footer-wrap" style={styles.footer}>
...
const styles = {
  footer: { backgroundColor: '#0a0a0a', padding: '64px 48px 32px' },
  top: { display: 'flex', justifyContent: 'space-between', marginBottom: '48px' },
  brand: { maxWidth: '240px' },
  logo: { fontWeight: '800', fontSize: '20px', color: 'white', marginBottom: '12px', cursor: 'pointer' },
  accent: { color: '#2563eb' },
  tagline: { fontSize: '14px', color: '#6b7280', lineHeight: '1.6' },
  linksGroup: { display: 'flex', gap: '64px' },
  linkCol: {},
  colTitle: { fontSize: '12px', fontWeight: '700', color: 'white', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '16px' },
  colLink: { fontSize: '14px', color: '#6b7280', marginBottom: '10px', cursor: 'pointer' },
  bottom: { display: 'flex', justifyContent: 'space-between', borderTop: '1px solid #1f2937', paddingTop: '24px' },
